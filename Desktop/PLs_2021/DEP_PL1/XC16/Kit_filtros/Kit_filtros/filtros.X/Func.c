...
void filtrar (void)
{
    ...
    extern FIRStruct rechazobandaFilter;

   	FIRDelayInit (&rechazobandaFilter); //Inicializamos el Filtro

  	FIR (NUM_SAMPLES, &filtrada[0], &entrada[0], &rechazobandaFilter); //Llamamos a la rutina de Filtro
